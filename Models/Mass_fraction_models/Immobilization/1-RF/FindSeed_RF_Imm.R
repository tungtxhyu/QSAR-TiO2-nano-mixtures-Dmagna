...
for (i in 1:1000) {
  ...
  RFmodel <- train(Immobilization ~ ., data = train, method = "qrf", trControl = train.control)
  print(RFmodel)
...
saveWorkbook(ExcelFile, paste(QSARFolder,"/","FindSeed_RF_Imm_Dmix9.xlsx", sep = ""), overwrite = TRUE)
