...
QMFile <- dlg_open(title = "Select excel file Descriptors", filters = dlg_filters[c("All"), ])$res; QMFolder <- dirname(QMFile)
...
saveWorkbook(ExcelFile, paste(MeOxFolder,'/Imm_Dmix.xlsx', sep=""), overwrite = TRUE)
